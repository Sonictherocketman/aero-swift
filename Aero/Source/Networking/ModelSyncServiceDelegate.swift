...
extension ModelSyncServiceDelegate {
     ...
     * delegate during syncing.
     */
    func modelSyncServiceDidFinishSync(_ modelSyncService: ModelSyncService) {}
     ...
     */
    func modelSyncService(_ modelSyncService: ModelSyncService, didEncounterError: Error, sendingData: Any?) -> Bool {
        return false
    }
     ...
     */
    func modelSyncService(_ modelSyncService: ModelSyncService, didEncounterError: Error, receivingData: Any?) -> Bool {
        return false
    }
}
